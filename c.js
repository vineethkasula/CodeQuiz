...
var questions=[
    ["#include<stdio.h>\nmain()\n{unsigned x = 5,y=& x, \n*p = y+0;\nprintf('%u', *p)}", "Address of x", "Address of y", "Address of p", "5", "D"],
    ["What is the size of ‘int’?", "2", "4", "8", "compiler independent", "D"],
    
    ["Identify the invalid constant used in fseek() function as ‘whence’ reference.", "SEEK_SET", "SEEK_CUR", " SEEK_BEG", "SEEK_END", "C", ],
    ["Which library functions help users to dynamically allocate memory?", "memalloc()and alloc()",
        "malloc() and memalloc()", "malloc() and calloc()", "memalloc() and calloc()","C"],
    ["How to round-off a value “5.77” to 6.0?", "ceil(5.77)", "round-off(5.77)", "round-up(5.77)", "floor(5.77)", "A"]
    ];
